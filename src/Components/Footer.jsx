            ...
            <div className=' bg-[#018837] px-32 py-6 min-h-screen mt-[40px]'>
                ...
                <div className='flex items-center flex-col justify-center h-[100%] gap-44 '>
                    ...
                    <div className='w-1/2  flex flex-col items-center '>
                        <h1 className='text-center text-white font-bold text-6xl  mb-6 font-inter pt-40'>Try ChopLine today</h1>
                        <p className='text-center text-xl font-normal text-white font-inter'>Get started for free.</p>
                        <button className="flex items-center gap-2 bg-black rounded-lg px-6 py-4 mt-7 text-white w-fit">
                        ...
                        <div className='flex gap-8 mt-10'>
                            <span><Facebook size={100}/></span>
                            <span><Facebook size={100}/></span>
                            <span><Facebook size={100}/></span>
                        </div>
                    </div>
                    <div className=''>
                        <div className=' flex gap-20 mb-[120px]'>
