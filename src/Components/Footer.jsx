...
const Footer = () => {
    return (
        <div>
            <div className=' bg-[#018837] px-32 py-6 min-h-screen mt-[40px] max-lg:px-10'>

                <div className='flex items-center flex-col justify-center h-[100%] gap-44 '>

                    <div className='w-1/2  flex flex-col items-center max-lg:w-[300px]'>
                        ...
                        <button className="flex items-center gap-2 bg-[#FFE492] rounded-lg px-6 py-4 mt-7 text-black w-fit ">
                            <span className='font-normal text-base font-inter max-lg:text-sm'>Try ChopLine free</span><ArrowRight size={19} />
                        </button>

                        <p className='mt-7 text-white font-normal text-xl font-inter max-lg:text-base'>On a big team? Contact sales </p>
                    ...
                    <div className=''>
                        <div className=' flex gap-20 mb-[120px] max-lg:gap-10 max-[940px]:gap-10 
                         max-[940px]:flex-wrap max-lg:items-center max-lg:justify-center'>
