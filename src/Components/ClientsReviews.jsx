...
//       <img src='client.svg' alt='client' className='absolute right-[266px] -z-10 top-2 max-lg:size-40 max-lg:-top-14 max-lg:right-72' />
//       <h1 className='font-bold text-6xl mb-12 text-center font-inter text-[#212529] max-lg:text-3xl'>What Our Clients Say</h1>
...
//               <div className={`py-14 px-10 rounded-lg shadow-2xl flex flex-col justify-between ${index % 2 !== 0 ? 'bg-[#018837] text-white' : ''}`}> 
//                 <div>
//                   <Quote className={`${index % 2 !== 0 ? 'text-white' : ''}`} />
//                   <p className={`text-base font-normal mt-6 mb-10 font-inter ${index % 2 !== 0 ? 'text-white' : ''}`}>whitepate is designed as a collaboration tool for businesses that is a full project management solution.</p>
//                   <hr className={`${index % 2 !== 0 ? 'border-white' : 'border-black'} w-full h-[1px] mb-10`} />
//                 </div>
...
//                     <h6 className={`font-semibold text-xl font-inter ${index % 2 !== 0 ? 'text-[#043873]' : 'text-[#212529]'}`}>Steve Smith</h6>
//                     <p className={`font-normal text-base font-inter ${index % 2 !== 0 ? 'text-white' : 'text-[#212529]'}`}>Head of Talent Acquisition, North America</p>
//                   </div>
//                 </div>
//               </div>
//             </SwiperSlide>
...
//       <div className='cards flex gap-6 max-[940px]:hidden'>
//         {[...Array(3)].map((_, index) => (
//           <div key={index} className={`py-14 px-10 rounded-lg shadow-2xl flex flex-col justify-between ${index % 2 !== 0 ? 'bg-[#018837] text-white' : ''}`}> 
//             <div>
//               <Quote className={`${index % 2 !== 0 ? 'text-white' : ''}`} />
//               <p className={`text-base font-normal mt-6 mb-10 font-inter ${index % 2 !== 0 ? 'text-white' : ''}`}>whitepate is designed as a collaboration tool for businesses that is a full project management solution.</p>
//               <hr className={`${index % 2 !== 0 ? 'border-white' : 'border-black'} w-full h-[1px] mb-10`} />
  ...
  return (
    <div className="mt-28 px-6 md:px-16 lg:px-32 relative">
      <img
        src="client.svg"
        alt="client"
        className="absolute right-10 lg:right-[266px] -z-10 top-2 w-28 md:w-40 lg:w-auto max-md:-top-10 max-md:right-36"
      />
