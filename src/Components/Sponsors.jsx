...
const Sponsors = () => {
    return (
        <div className='min-h-screen  flex flex-col justify-between items-center relative'>
            <img src="sponsors.svg" alt="sponsors" className='absolute top-[162px] right-[405px] max-lg:size-40 max-lg:top-[104px] max-[940px]:right-80 max-md:top-24 max-md:right-64 max-sm:right-52' />
